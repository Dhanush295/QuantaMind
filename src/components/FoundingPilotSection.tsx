      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            ...
            <div className="flex items-center gap-2 bg-green-500/20 border border-green-500/40 px-6 py-3 rounded-full">
              <Mail className="h-6 w-6 text-green-400" />
              <span className="font-bold text-green-300">Priority access</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Option 1: Free Pilot */}
            <Card className="border-2 border-green-500/40 bg-gradient-to-br from-green-500/10 to-green-400/5 relative overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-lg">
              <div className="absolute top-0 left-0 bg-gradient-to-r from-green-500 to-green-400 text-white px-4 py-2 text-sm font-bold rounded-br-lg">
                MOST POPULAR
              </div>
            ...
            <Card className="border-2 border-quantminds-blue/40 bg-gradient-to-br from-quantminds-blue/10 to-quantminds-blue/5 relative overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-lg">
              <div className="absolute top-0 left-0 bg-gradient-to-r from-quantminds-blue to-quantminds-blue/80 text-white px-4 py-2 text-sm font-bold rounded-br-lg">
                PREMIUM
              </div>
              <CardHeader className="pt-8">
                <CardTitle className="text-xl text-center flex items-center justify-center gap-2">
