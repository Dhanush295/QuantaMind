      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            <span className="text-gradient">Founded by Engineers,</span> Backed by Experience
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our team combines deep technical expertise with real-world enterprise experience to deliver AI solutions that work.
          </p>
        </div>
